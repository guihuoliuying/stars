 ...
 */
public interface FamilyWarRemoteService extends ActorService, Service {
    ...
    @AsyncInvocation
    void onGenerateFinish(int serverId, int battleType, Map<Integer, List<Long>> groupOfFamilyMap,
                          LinkedHashMap<Integer, Long> indexFamilyId, Set<Long> outOfWarFamily);

    @AsyncInvocation
    void SyncBattleType(int serverId, int battleType);

    @AsyncInvocation
    void update_1stTO_4thFamily(int serverId, long _1st, long _2nd, long _3rd, long _4th);
    ...
    @AsyncInvocation
    void sendFixtures(int serverId, int fromServerId, long familyId, long roleId);
    ...
    @AsyncInvocation
    void chat(int serverId, String message);
