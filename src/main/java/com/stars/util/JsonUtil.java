...
public class JsonUtil {
	 ...
	 * <p />
	 * <strong>该方法转换发生错误时，不会抛出任何异常�?若发生错误时，曾通对象返�?<code>"{}"</code>�?集合或数组对象返�?
	 * <code>"[]"</code> </strong>
	 * 
	 * @param target
	 *            目标对象�?
	...
	/**
	 * 将给定的目标对象转换�?{@code JSON} 格式的字符串�?strong>此方法只用来转换普�?�?{@code JavaBean} 对象�?/strong>
	 * <ul>
	...
	/**
	 * 将给定的 {@code JSON} 字符串转换成指定的类型对象�?<strong>此方法�?常用来转换普通的 {@code JavaBean}
	 * 对象�?/strong>
	 * 
	 * @param <T>
	 *            要转换的目标类型�?
	 ...
	 * 集合或数组对象返�?<code>"[]"</code>�?其本基本类型，返回相应的基本值�?
	 * 
	 * @param target
	 *            目标对象�?
	 * @param targetType
	...
	public static HashMap<String, String> jsonToMap(String json) {
		...
		HashMap<String, String> map = (HashMap<String, String>) gson.fromJson(json, new TypeToken<HashMap<String,String>>() {
		}.getType());
		return map;
	}
	
	public static String getValueFromJsonstring(String json,String key){
		HashMap<String, String> list = jsonToMap(json);
		return list.get(key);
	}
