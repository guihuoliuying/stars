...
/**
 * Created by zhaowenshuo on 2017-06-16.
 */
public class OpActBenefitTokenScene extends FightScene {
    ...
    public void enter(Map<String, Module> moduleMap, Object obj) {
        ...
        com.stars.util.LogUtil.info("伙伴关卡开始时间戳:{}", startTimestamp);
        ...
        logModule.Log_core_activity(ServerLogConst.ACTIVITY_START, ThemeType.ACTIVITY_39.getThemeId(), logModule.makeJuci(),
                ThemeType.ACTIVITY_39.getThemeId(), stageId, 0);
    }

    @Override
    public void updateTimeExecute(Map<String, Module> moduleMap) {
        super.updateTimeExecute(moduleMap);
    }
    ...
    public void finishDeal(Map<String, Module> moduleMap, byte finish) {
        ...
        ClientStageFinish clientStageFinish = new ClientStageFinish(SceneManager.SCENETYPE_OPACT_BENEFIT_TOKEN_DUNGEON, finish);
        ...
        ServerLogModule logModule = (ServerLogModule) moduleMap.get(MConst.ServerLog);
        logModule.Log_core_activity(logType, ThemeType.ACTIVITY_39.getThemeId(), logModule.makeJuci(),
                ThemeType.ACTIVITY_39.getThemeId(), stageId, (endTimestamp - startTimestamp) / 1000);
    }
