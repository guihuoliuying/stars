 ...
 */
public class BuddyAchieveEvent extends Event {
    ...
    public BuddyAchieveEvent(int buddyId, byte type, int preLevel, int curLevel , Map<Integer, Integer> roleBuddyLevelMap) {
