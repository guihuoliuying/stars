 ...
 */
public class FamilyAuthAchieveEvent extends Event {
    ...
    public FamilyAuthAchieveEvent(long roleId, long familyId, String familyName, int familyLevel, FamilyPost post, long prevFamilyId) {
    ...
    public FamilyAuthAchieveEvent(byte type, long roleId, long familyId, String familyName, int familyLevel, FamilyPost post, long prevFamilyId) {
        this.type = type;
        this.roleId = roleId;
        this.familyId = familyId;
        this.familyName = familyName;
