 ...
 */
public class ActRevieveRewardRecord extends DbRow {
    private long roleId;
    private int operateActId;
    private int rewardId;
    private int revieveCount;
    
    public ActRevieveRewardRecord() {
    	
    }
    
    public ActRevieveRewardRecord(long roleId , int operateActId , int rewardId , int revieveCount) {
        this.roleId = roleId;
