 ...
 */
public class AchieveSigninListener extends AbstractEventListener {
    public AchieveSigninListener(Module module) {
        super(module);
    }
    ...
    public void onEvent(Event event) {
        ...
        achievementModule.triggerCheck(AchievementHandler.TYPE_SIGNIN, event);
    }
}
