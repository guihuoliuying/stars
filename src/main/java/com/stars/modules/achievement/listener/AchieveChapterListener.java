 ...
 */
public class AchieveChapterListener extends AbstractEventListener {
    public AchieveChapterListener(Module module) {
        super(module);
    }
    ...
    public void onEvent(Event event) {
        ...
        am.triggerCheck(AchievementHandler.TYPE_CHAPTER, event);
    }
}
