 ...
 */
public class AchieveBuddyListener extends AbstractEventListener {

    public AchieveBuddyListener(Module module) {
        super(module);
    }
    ...
    public void onEvent(Event event) {
        ...
        achievementModule.triggerCheck(AchievementHandler.TYPE_BUDDY, event);
    }
}
