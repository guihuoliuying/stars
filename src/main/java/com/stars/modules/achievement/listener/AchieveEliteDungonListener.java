 ...
 */
public class AchieveEliteDungonListener extends AbstractEventListener {
    public AchieveEliteDungonListener(Module module) {
        super(module);
    }
    ...
    public void onEvent(Event event) {
        ...
        am.triggerCheck(AchievementHandler.TYPE_ELITE_DUNGEON, event);
    }
}
