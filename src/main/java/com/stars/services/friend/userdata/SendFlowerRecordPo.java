 ...
 */
public class SendFlowerRecordPo extends DbRow implements Comparable<SendFlowerRecordPo> {
    private long roleId;
    ...
    public SendFlowerRecordPo() {
    }

    public SendFlowerRecordPo(long roleId, long friendId, String friendName, int count, int jobId, int level) {
        this.roleId = roleId;
    ...
    public String getChangeSql() {
        return SqlUtil.getSql(this, DBUtil.DB_USER, "sendflowerrecord", "`roleid`=" + roleId + " and `friendid`=" + friendId + " and `occurtimestamp`=" + occurTimestamp);
    }

    @Override
    public String getDeleteSql() {
        return "delete from `sendflowerrecord` where `roleid`=" + roleId + " and `friendid`=" + friendId + " and `occurtimestamp`=" + occurTimestamp;
    }
    ...
    @Override
    public int compareTo(SendFlowerRecordPo po) {
