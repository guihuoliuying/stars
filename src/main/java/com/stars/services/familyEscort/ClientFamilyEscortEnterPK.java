 ...
 */
public class ClientFamilyEscortEnterPK extends ClientEnterFight {
    private int limitTime;// 倒计时,单位秒
    private int countdownOfBegin;//开始倒计时
    private byte isAttacker = 0; //是否是主动攻击者 0否 1是
	...
	public byte getIsAttacker() {
		return isAttacker;
	}

	public void setIsAttacker(byte isAttacker) {
