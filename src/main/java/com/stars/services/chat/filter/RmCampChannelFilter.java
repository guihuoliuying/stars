 ...
 */
public class RmCampChannelFilter extends RMChannelFilter {
    public RmCampChannelFilter(String flag, ChatServiceActor serviceActor) {
    ...
    public Object filter0(Object object) {
        if (object instanceof ChatMessage) {
            ...
            if (chatMessage.getChannel() != ChatManager.CHANNEL_RM_CAMP) {
                return chatMessage;
            }
